...
public class BedrockParseHelper {
    public static ParseResult parseBedrockResponse(String rawResponse, List<FileDto> originalFiles, ObjectMapper objectMapper) {
        try {
    ...
    private static List<FileDto> extractChangedFiles(String json, List<FileDto> originalFiles) {
